...
const page = () => {
  return (
    <>
      <Hero bread={["Gallery", "Home"]} page="Gallery" />
      <div className="bg-gray-100">
        <div className="container mx-auto px-4 py-8">
          <TitleSection
            title="Gallery"
            description="All of our products are organic & fresh."
          />

          {/* GALLERY */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 foo">
            {/* <!-- Large item --> */}
            <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-2xl shadow-lg group">
              <PhotoView src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxuYXR1cmV8ZW58MHwwfHx8MTcyMTA0MjYwMXww&ixlib=rb-4.0.3&q=80&w=1080">
                <img
